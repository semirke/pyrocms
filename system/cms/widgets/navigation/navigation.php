...
class Widget_Navigation extends WidgetAbstract
{
    ...
    public function run($options)
    {
        ...
        $params = array(
            'user_group' => ($this->current_user && isset($this->current_user->group)) ? $this->current_user->group : false,
            'front_end' => true,
            'is_secure' => Request::secure(),
        );

        $links = Navigation\Model\Links::getTreeByGroup($options['group'], $params);
